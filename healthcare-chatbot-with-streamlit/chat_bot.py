...
def tree_to_code(tree, feature_names):
    ...
    while True:
        ...
        st.write("Enter the symptom you are experiencing  \n\t\t\t\t\t\t",end="->")
        disease_input = st.text_input("", key="2323")
        ...
        if conf==1:
            ...
            if num!=0:
                ...
                conf_inp = int(st.number_input("", key="43"))
            else:
                conf_inp=0
    ...
    while True:
        try:
            num_days=int(st.number_input("Okay. From how many days ? : ", key="20"))
            break
        except:
    ...
    def recurse(node, depth):
        ...
        if tree_.feature[node] != _tree.TREE_UNDEFINED:
            ...
            for syms in list(symptoms_given):
                ...
                st.write(syms,"? : ",end='')
                while True:
                    inp=st.text_input("", key=len(syms))
